...
sudo apt update
sudo apt install curl neovim python3 python3-pip git exuberant-ctags global npm -y
...
echo "[+] Done, welcome to \\033[1m\\033[92mNeoVim\\033[0m! Try it by running: nvim/vim."
