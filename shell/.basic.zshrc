...
# Vi Mode Start (http://stratus3d.com/blog/2017/10/26/better-vi-mode-in-zshell/)
...
# If you are using Vim and don’t want to load your entire .vimrc just to edit this command you can set $EDITOR to Vim with
# no config
